...
- **MiFID II Kostentransparenz (§ 63 Abs. 7 WpHG):** Ex-ante- und Ex-post-Kostenausweis inkl. Zuwendungen; MiFID Quick Fix (2021) hat Erleichterungen für professionelle Kunden gebracht [Q]. Für OTC-Derivate ist die Marge (Differenz Kundenpreis vs. Mid-Marktwert) der zentrale Kostenbestandteil [E].
...
- **Szenarioanalyse:** Parallel ±100/200 bp, Steepener/Flattener, EBA/BCBS-IRRBB-Szenarien, historische Stress-Tage.
...
| **PRIIPs** | KID für OTC-Derivate an Kleinanleger (Performance-Szenarien, Kosten) | [Q] |
